...
def get_names_for_place_ids(place_id_list):
    """
    This function takes as input a list of place ids and returns the corresponding place
    names from the Data Commons Graph. This is oddly slow
    """
    try:
        # get the place names for non-country GEO-LEVELS
        place_name_list = [
            dc.get_property_values([place_id], "name")[place_id][0]
